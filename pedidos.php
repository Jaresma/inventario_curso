                         	  ...
                         	  <table class="table" id="myTable">
                         	  	  ...
                         	  	  <thead>
                         	  	  	<tr>
                         	  	  		...
                         	  	  		<th>Cantidad</th>
                         	  	  		<th>Fecha</th>
                         	  	  		<th>RFC proveedor</th> <!-- rif_ proveedor in data base  -->
                         	  	  		<th>Acciones</th>
                         	  	  	</tr>
                         	  	  </thead>
                         	  	  ...
                         	  	  <tbody>
                         	  	  	<?php for($i=0;$i<sizeof($datos);$i++) {?>
                         	  	  	  <tr>
                         	  	  	  	...
                         	  	  	  	<td><a class="btn btn-success" href="editar_pedido.php?id_pedido=<?php echo $datos[$i]["cod_pedido"];?>"> <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Editar</a> 
										<a class="btn btn-danger" href="eliminar_pedido.php?id_pedido=<?php echo $datos[$i]["cod_pedido"];?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Eliminar</a></td>
                         	  	  	  </tr>
