							 ...
							 <table class="table" id="myTable">
							 	...
							 	<tbody>
							 		...
							 		<tr>
							 			...
							 			<td><a class="btn btn-success" href="editar_configuracion.php?id_configuracion=<?php echo $datos[$i]["codigo"];?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Editar</a> <a class="btn btn-danger" href="eliminar_configuracion.php?id_configuracion=<?php echo $datos[$i]["codigo"];?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Eliminar</a></td>
							 		</tr>
							 		<?php } ?>
							 	</tbody>
							 </table>
